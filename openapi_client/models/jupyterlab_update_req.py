...
class JupyterlabUpdateReq(BaseModel):
    """
    JupyterlabUpdateReq
    """ # noqa: E501
    job_name: StrictStr
    ...
    memory: StrictInt
    gpu_count: StrictInt
    gpu_product: StrictStr
    data_volume_size: StrictInt
    __properties: ClassVar[List[str]] = ["job_name", "cpu_count", "memory", "gpu_count", "gpu_product", "data_volume_size"]
