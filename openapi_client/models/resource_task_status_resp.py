...
class ResourceTaskStatusResp(BaseModel):
    """
    ResourceTaskStatusResp
    """ # noqa: E501
    data: List[ResourceSyncTask]
    total: StrictInt
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ResourceSyncTask.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total")
        })
        return _obj
