...
class Resource(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "object", "owner", "size", "is_public", "user_id", "tag", "template", "meta", "category", "base_model", "finetune_gpu_count", "inference_gpu_count"]
