...
class ResourceMetaAddReq(BaseModel):
    """
    ResourceMetaAddReq
    """ # noqa: E501
    ...
    resource_size: StrictInt
    is_public: StrictBool
    user_id: StrictStr
    meta: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["resource_id", "resource_type", "resource_name", "resource_size", "is_public", "user_id", "meta"]
